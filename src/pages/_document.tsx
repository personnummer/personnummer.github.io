...
export default class AppDocument extends Document {
  ...
  googleAnalyticsScript() {
    return `(function(b,o,i,l,e,r){b.GoogleAnalyticsObject=l;b[l]||(b[l]=
  ...
  render() {
    const { isProduction } = this.props as typeof this.props & { isProduction: boolean };
    ...
    return (
      <Html lang="en">
        ...
        <body>
          ...
          {isProduction && (
            <script
              dangerouslySetInnerHTML={{ __html: this.googleAnalyticsScript() }}
            />
          )}
        </body>
      </Html>
